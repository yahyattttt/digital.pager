...
const UNIFIED_FEATURES = [
  "بيجر رقمي لتنبيه العميل عند جاهزية الطلب",
  "توجيه العميل إلى صفحة تقييم متجرك على خرائط Google",
  "عرض ملاحظات وتجربة العميل داخل لوحة تحكم التاجر",
  "واجهة تشغيل سهلة وسريعة للمتجر",
];
