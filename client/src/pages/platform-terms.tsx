...
export default function PlatformTermsPage() {
  ...
  useEffect(() => {
    document.title = `${t("الشروط والأحكام", "Terms & Conditions")} | Digital Pager`;
    fetch("/api/public/platform-content")
      .then(r => r.json())
      .then(data => setContent(data.platformTermsText || ""))
      .catch(() => setContent(""))
      ...
      <div className="max-w-3xl mx-auto px-5 py-14">
        ...
        <div className="flex items-center gap-4 mb-10">
          <div style={{ background: "rgba(255,69,0,0.1)", border: "1px solid rgba(255,69,0,0.25)", borderRadius: 12, padding: "10px" }}>
            <FileText className="w-6 h-6" style={{ color: "#ff4500" }} />
          </div>
          <div>
            ...
            <h1 style={{ fontSize: "clamp(1.4rem, 3vw, 2rem)", fontWeight: 800, color: "#f0f0f0", margin: 0 }}>
        ...
        >
          {loading ? (
            ...
            <p
              data-testid="text-platform-terms-content"
