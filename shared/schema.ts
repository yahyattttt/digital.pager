...
export const merchantSchema = z.object({
  ...
  subscriptionStartAt: z.string().nullable().optional(),
  plan: planEnum.default("trial"),
  referralCode: z.string().optional(),
  referredBy: z.string().optional(),
  referralDiscount: z.boolean().optional(),
  subscriptionRequestStatus: z.enum(["none", "pending", "approved", "rejected"]).optional(),
  subscriptionRequestRejectionReason: z.string().optional(),
  subscriptionRequestedPlan: planEnum.optional(),
  subscriptionRequestedAt: z.string().optional(),
  subscriptionDocuments: z.array(z.string()).optional(),
  subscriptionRequestNotes: z.string().optional(),
