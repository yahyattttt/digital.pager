...
- **Customer Pager UI**: Premium "Digital Pager" aesthetic with dark gradients, featuring a circular PagerDevice component with SVG LED animations and DSEG7 font for order numbers.
  ...
  - **Audio Notification System**: Exclusive to the `preparing` screen, uses a silent oscillator to prevent AudioContext suspension in background tabs, ensuring reliable "order ready" bell alerts.
